    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Service Time - Detalle Historico</h1>
                            ...
                            <tbody>
							 <?php
                                ...
                                <tr>
                                    ...
                                    <td><h5 class="text-gray-800"><?php echo $fechaF ?></h5></td>
                                </tr>   
                                <tr>
								...
								<form action="logica/cambioEstado2.php?v1=<?php echo $idOrden?>" method="post">
										...
										<INPUT class="btn btn-success "  name="Z_aprovar" TYPE="submit"  style="display:<?php echo$estBtn?> ;" VALUE="Listo">
