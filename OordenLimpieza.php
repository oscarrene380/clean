    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Service Time - Orden de Limpieza</h1>
              ...
              <div class="card-body">
			   ...
			   include("include/conexionDirectaPruebas.php");
				...
				$idUserAsignado = $_SESSION['user'];
				      ...
				      $query="call SpListadoOrdenesLimpiezaFiltradas(0,'$idUserAsignado','','');";
						...
						?>
      								...
      								<tr>			
										...
										<td>
										<a href="OdetalleOrdenLimpieza.php?id=<?php echo $id?>" class="btn btn-info btn-icon-split">
