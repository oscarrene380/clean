		  ...
		  <!--FORM PARA NO PERDERLO :v -->
					 <form class="user"  method="POST" action="logica/controller.php">
					    ...
					    <div class="form-group">
								<input type="text" class="form-control form-control-user" id="" name="descripcion" placeholder="Descripcion" required>
						</div>
					  ...
					  <!-- submit -->
					  <div class="form-group">
					  <a href="AgestionarEdificios.php" class="btn btn-info btn-icon-split">
								<span class="icon text-white-50">
								  <i class="fas fa-arrow-left"></i>
								</span>
								<span class="text">Volver</span>
						 </a> 
					  <input type="submit" class="btn btn-primary col-sm-2" name="btnAgregarEdificio" >
