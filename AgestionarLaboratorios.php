        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-2">
			...
			<div class="card-header py-3">
			     ...
			     <a href="AagregarLaboratorio.php" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
					<i class="fas fa-laptop"></i>
                    </span>
                    <span class="text">Agregar Nuevo Laboratorio</span>
                  </a> 
			...
			<?php $response = peticion_get($EndPointLaboratorios); ?>
                      ...
                      <?php foreach ($response as $key => $value): ?>
      								<tr>			
        								<td><?= $response[$key]->laboratorio ?></td>
        								<td><?= $response[$key]->edificio ?></td>
