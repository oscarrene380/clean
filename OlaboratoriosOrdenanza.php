    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Service Time - Laboratorios Asigandos</h1>
            ...
            <div class="table-responsive-lg">
			   ...
			   include("include/conexionDirectaPruebas.php");
				...
				$idUserAsignado = $_SESSION['user'];
				      ...
				      $query="SELECT l.idlab,l.nombre,l.descripcion,e.nombre as edificio FROM laboratorio as l 
					  inner join usuario as u on u.idlab=l.idlab 
					  inner join edificio as e on e.idEdificio=l.idEdificio 
					  where u.idUser='$idUserAsignado';";
