...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Service Time - Detalle Orden</h1>
								  ...
								  <?php
								   include("include/conexionDirectaPruebas.php");
                                    ...
                                    <tr>
										...
										<form action="logica/cambioEstado.php?v1=<?php echo $idOrden?>&v2=<?php echo $idDato?>" method="post">
										...
										<INPUT class="  btn btn-danger "   name="B_Rechazar" TYPE="submit"  style="display:<?php echo$estBtn?>;	" VALUE="Cancelar">
												
										<INPUT class="btn btn-success "  name="B_aprovar" TYPE="submit"  style="display:<?php echo$estBtn?> ;" VALUE="En Proceso">
  ...
  <!-- Cancel2-->
  <div class="modal fade" id="Cancel2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">¿Desea cancelar la orden?</h5>
