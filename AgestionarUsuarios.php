      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Service Time - Gestion de Usuarios</h1>
          ...
          <div class="card shadow mb-2">
			...
			<div class="card-header py-3">
			     ...
			     <a href="AagregarUsuario.php" class="btn btn-success btn-icon-split">
            ...
            <div class="card-body">
  			<div class="table-responsive">
                ...
                <?php $response = peticion_get($EndPointUsuario); ?>
                      ...
                      <?php foreach ($response as $key => $value): ?>
      								<tr>			
        								...
        								<td><?= $response[$key]->nombre ?></td>
        								<td><?= $response[$key]->apellido ?></td>
        								<td><?= $response[$key]->edad ?></td>
                                        <td><?= $response[$key]->tipo ?></td>
										<td><?= $response[$key]->turno ?></td>
        								<td width="10">
          								<a href="AdetalleUsuario.php?buscar=<?= $response[$key]->idUser ?>" class="btn btn-info btn-icon-split" >
          								 <span class="icon text-white-50">
              ...
              <a href="inicioAdmin.php" class="btn btn-info btn-icon-split">
                <span class="icon text-white-50">
