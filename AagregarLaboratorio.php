      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Service Time - Agregar Edificio</h1>
					...
					<?php endif; ?>
						...
						<div class="form-group row">
							  <div class="col-sm-6 mb-3 mb-sm-0">
								<input type="text" class="form-control form-control-user" id="" name="nombre" placeholder="Nombre" required>
							  </div>
						</div>
					    <div class="form-group">
						        <textarea name="descripcion" class="form-control" rows="5" cols="50" placeholder="Descripcion" ></textarea>
						</div>
						<hr>
						...
						<div class="form-group row">
							...
							<label for="">Edificio:</label>
								  <select name="idEdificio"   class="form-control " required >
									<option value="">- seleccione un laboratorio -</option>
									  <?php $response = peticion_get($EndPointEdificio); ?>
									  <?php foreach ($response as $key => $value): ?>
										<option value="<?= $response[$key]->idEdificio ?>"><?= $response[$key]->nombre ?></option>
									  <?php endforeach; ?>
								  </select>
						    </div>
					    </div>
					  ...
					  <input type="submit" class="btn btn-primary col-sm-2" name="btnAgregarLaboratorio" >
