...
<span class="sr-only">Loading...</span></i></div>  
   ...
   <!-- Nav Item - Tables -->
		  <li class="nav-item">
			<a class="nav-link" href="inicioEncargado.php">
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="EcrearHorarioEncargado.php">
		   <i class="fas fa-calendar-plus"></i>
          <span>Programar limpieza</span></a>		  
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="EverOdenesEncargado.php">
		   <i class="far fa-calendar-alt"></i>
          <span>Ver horarios</span></a>
		  
      </li>
	  
	  <li class="nav-item">
        <a class="nav-link" href="EcambiarContraEncargado.php">
