    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Service Time - Historico</h1>
              ...
              <div class="table-responsive-lg">
			   ...
			   include("include/conexionDirectaPruebas.php");
				...
				$idUserAsignado = $_SESSION['user'];
				      ...
				      $query="SELECT h.idOrden,o.titulo,fechaestado, e.nombre FROM historicoestado as h 
					  inner join estadoordenlimpieza as e on h.idEstadoOrden = e.idEstadoOrden 
					  inner join ordenlimpiezalab as o on h.idOrden=o.idOrden
					  where idUser='$idUserAsignado';";
							...
							while($fila=mysqli_fetch_array($ejecutar)){
								$id = $fila['idOrden'];
								$nombre = $fila['titulo'];
								$descripcion = $fila['fechaestado'];
								$edificio = $fila['nombre'];
